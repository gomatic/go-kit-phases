...
type SelfClient interface {
	...
	List(ctx context.Context, in *Query, opts ...grpc.CallOption) (*Feelings, error)
}
...
func (c *selfClient) List(ctx context.Context, in *Query, opts ...grpc.CallOption) (*Feelings, error) {
	out := new(Feelings)
...
type SelfServer interface {
	...
	List(context.Context, *Query) (*Feelings, error)
...
func (UnimplementedSelfServer) List(context.Context, *Query) (*Feelings, error) {
